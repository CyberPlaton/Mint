...
namespace mint
{
	...
	bool CScriptLoader::load_ressource(const String& ressource_type, CAsset& asset)
	{
		MINT_ASSERT(ressource_type == "Script", "Invalid asset type provided!");
		...
		{
			mint::scripting::CScriptEngine::Get().add_script_to_scene(asset.get_asset_name(),
	...
	mint::CAsset CScriptLoader::load_asset(const String& ressource_container_folder, const String& ressource_type, maml::SNode* node)
	{
		MINT_ASSERT(ressource_type == "Script", "Invalid asset type provided!");
