...
namespace mint::editor
{
	...
	{
		MINT_PROFILE_SCOPE("CSpriteComponentEditor::on_update", "Editor::ComponentEditor");
	...
	{
		MINT_PROFILE_SCOPE("CSpriteComponentEditor::on_ui_frame", "Editor::ComponentEditor");
